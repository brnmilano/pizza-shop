...
} from "@/models/orderFiltersValidationSchema";
...
export default function OrderTableFilters() {
  ...
  const { register, handleSubmit, control, reset } =
    useForm<orderFilterValidationSchema>({
  ...
  const handleFilter = (data: orderFilterValidationSchema) => {
  ...
  return (
    ...
    >
      ...
      <Button onClick={handleRemoveFilters} type="button" variant="outline">
